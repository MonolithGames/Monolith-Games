...
Apache HTTPD is the public edge. Monolith listens privately on `127.0.0.1:8080`
...
certificate. Keep port 8080 private; expose only ports 80 and 443 at the edge.
